"""
Temporarily disabled FastAPI entrypoint.

The retrieval service can be tested without HTTP by using:
  python3 scripts/retrieve_code_chunk_candidates.py --input-json /abs/path/to/chunk.json
  python3 scripts/retrieve_code_chunk_candidates.py --chunk-id YOUR_CHUNK_ID
"""
