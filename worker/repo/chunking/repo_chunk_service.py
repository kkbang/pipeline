...
def _build_chunk_doc_source(
    *,
    ...
    source = {
        ...
        "context_decorators": candidate.context_decorators,
        "context_class_signature": candidate.context_class_signature or None,
        "context_parent_class": candidate.context_parent_class or None,
        "context_exports": candidate.context_exports,
